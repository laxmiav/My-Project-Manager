...
class __TwigTemplate_7cb85959fc965c85c072865f7d2b2fc4 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 34
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("projets_tasks", ["id" => twig_get_attribute($this->env, $this->source, $context["projet"], "id", [], "any", false, false, false, 34)]), "html", null, true);
...
\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t<a href=\"{{ path('projets_tasks', {'id': projet.id}) }}\">Related Tasks</a>
