...
class __TwigTemplate_b5f59d8d7426e3c87afd10776cae02a3 extends Template
{
  ...
  ";
        ...
        echo "
         ";
        // line 8
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 8, $this->source); })()), "Deadline_date", [], "any", false, false, false, 8), 'row', ["attr" => ["class" => "form-control :"]]);
        // line 10
        echo "
        ";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "Priority", [], "any", false, false, false, 11), 'row', ["attr" => ["class" => "  :"]]);
        // line 13
        echo "
         ";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "Project", [], "any", false, false, false, 14), 'row', ["attr" => ["class" => "form-control   :"]]);
        // line 16
        echo "
...
";
    ...
    {
        return array (  79 => 21,  74 => 20,  69 => 16,  67 => 14,  64 => 13,  62 => 11,  59 => 10,  57 => 8,  54 => 7,  52 => 5,  49 => 4,  47 => 2,  43 => 1,);
    }
...
{{ form_end(form) }}
", "tasks/_form.html.twig", "C:\\Users\\ADMIN\\Desktop\\Symfony-projects\\project_manager\\templates\\tasks\\_form.html.twig");
    }
}
